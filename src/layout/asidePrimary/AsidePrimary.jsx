  ...
  return (
    <aside className='mt-[10rem] flex justify-start h-[38.5rem] items-center  flex-col border-[1px] rounded-[0.75rem] border-primary-10 overflow-hidden'>
      ...
      <ul>
        {country.map((d, i) => (
          <div key={i}>
            <li className='relative flex group w-[21.8125rem] items-center space-x-[1rem] px-[1.5rem] py-[0.5rem]'>
              <Image
              ...
              <svg
                className='z-[1] group-hover:opacity-0 duration-700 opacity-100 size-[1.25rem]'
              ...
              >
                <path
                  d='M7.5 4.78125L13.3333 10.6146L7.5 16.4479'
                  stroke='#132B7D'
                  strokeWidth={2}
                  strokeLinecap='round'
              ...
              <div className='absolute group-hover:opacity-100 duration-700 opacity-0 flex-1 z-[1] button1 text-white uppercase '>
                {d.tittle}
              </div>
            </li>
            {i !== country.length - 1 && (
      ...
      <ul className=''>
        {dataBanner?.map((d, i) => (
          <li key={i} >
            ...
            {i !== dataBanner?.length - 1 && <div className=" w-[18.125rem] my-[0.033rem] h-[0.03125rem] mx-auto shrink-0 bg-primary-60 opacity-10"></div >}
          </li>
        ))}
      </ul>
    </div>
