      ...
      <div className=" md:w-[100rem] xlg:w-full xlg:relative flex items-center justify-center shrink-0">
        ...
        <div className='flex items-center xmd:!px-[0.75rem] xlg:px-[4.75rem]  xmd:py-[0.75rem] xlg:w-full xlg:justify-between md:space-x-[11.12rem]'>
          <Link
            ...
            href='/'
          >
            <Image priority alt="ảnh logo du học đức anh" src={data_header?.logo} width={235} height={69}
          ...
          <NavMobi setOpenNavMobile={setOpenNavMobile} openNavMobile={openNavMobile} data_header={data_header} />

          <div onClick={() => setOpenNavMobile(true)} className="flex lg:hidden bg-elevation-20 xmd:size-[2rem] xlg:size-[6.5rem] justify-center items-center gap-[0.2rem] p-[0.4rem] rounded-[5rem]">
            <Image
              loading='lazy'
