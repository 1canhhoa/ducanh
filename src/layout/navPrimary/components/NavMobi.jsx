...
const NavMobi = ({ openNavMobile, isPopupMounted, data_header, setOpenNavMobile, handleCloseNav }) => {
  ...
  return (
    <>
      {openNavMobile && <div
        className={
          'block overflow-y-auto no-scrollbar h-screen w-screen fixed top-0 bottom-0 left-0 z-[300] bg-white lg:hidden ease-linear duration-200 ' +
          (openNavMobile && isPopupMounted ? 'left-0' : ' left-[100%]')
        }
      >
