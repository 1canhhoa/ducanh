  ...
  return (
    <div className='relative w-full'>
      ...
      <div
        ...
        <div className=" contentlk md:flex md:items-center xmd:grid xmd:grid-rows-2 xmd:grid-flow-col xmd:grid-cols-3 xmd:gap-x-[2.7rem] xmd:pl-[1.4rem] ">
          <Swiper
            slidesPerView='auto'
          ...
          >
            {displayData.map((d, i) => (
              <SwiperSlide className='!w-fit !pointer-events-none'>
                <div key={i} className="duration-500 w-fit flex z-[100] flex-col space-y-[0.75rem] md:h-[9.1875rem] justify-center items-center  py-[1.4375rem] md:px-[2.65625rem]">
