  ...
  return (
    <div className='mt-[2rem] z-[10] h-[46em] space-y-[1.25rem]  w-full relative'>
      <div className="px-[0.75rem] flex z-[1] flex-col  md:absolute top-20 left-20 items-start space-y-[0.5rem]">
        ...
        <Title
          title={t.dich_vu_duc_anh}
          className={'xmd:text-[1.75rem] xmd:font-bold xmd:leading-[1.3]'}
        />
      </div>
      ...
      <div className=' h-[19rem] absolute bottom-[0rem] w-full z-[-1]'>
        ...
        <Image
          className='absolute bottom-[0rem] w-full left-0'
          riority
          alt='ảnh'
          src={'/images/homepage/bg-dichvu-mobi.png'}
          width={500}
          height={500}
        />
      </div>
