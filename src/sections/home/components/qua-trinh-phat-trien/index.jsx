...
const Section = ({ num, text, mobi }) => {
  ...
  shadow-[0px_3px_24px_0px_rgba(0,132,255,0.04),0px_0px_32px_0px_rgba(0,119,229,0.04)] rounded-[1.08213rem]`}>
    <div className='inline-flex flex-col items-center'>
      <div className={` ${mobi ? '!text-white' : 'text_gradient from-[#2E6BC6] from-[9.83%]  via-[#2E6BC6] via-[9.83%]  to-[#29A4EA] to-[86.69%]'}   text-6xl not-italic font-extrabold leading-[130%] tracking-[-0.1875rem] bg-clip-text
      xmd:text-[2.75rem]  xmd:tracking-[-0.1375rem]
         bg-gradient-to-r from-[#2B46A8] from-[100%] to-[#082072] to-[0%]
         hover:bg-[url("/images/homepage/bg-text.svg")]
         ease-linear duration-1000
         `}>{num}</div>
      <div className={`${mobi ? '!text-white' : 'xmd:w-[5.1875rem] from-[#2E6BC6] from-[9.83%]  via-[#2E6BC6] via-[9.83%]  to-[#29A4EA] to-[86.69%] text-center text_gradient'} text-base not-italic font-extrabold leading-[130%] tracking-[-0.02rem] bg-clip-text
...
// background: linear - gradient(180deg, #082072 0 %, #2B46A8 100 %);
...
const QuaTrinhPhatTrien = ({ isMobile }) => {
  ...
  return (
    <>
      <div className="relative  xmd:flex xmd:flex-col justify-center items-center  xmd:pt-[4.3rem] pt-[6rem]">
        {/* title */}
        ...
        <Image priority alt="ảnh" src={'/images/homepage/bg-quatrinh.png'} width={1600} height={1700} className="xmd:hidden w-full h-full" />
        {/* MOBI ảnh trường học và ảnh nền xanh + CÔ ÁO ĐỎ */}
        <div className="md:hidden h-[50.25rem] w-screen relative">
          <Image className="z-[2] absolute top-[-2.4rem] w-screen " priority alt="" src={'/images/homepage/quatrinh-mobi.png'} width={730} height={720} />
          <Image className="z-[1] absolute top-[12.25rem] w-screen" priority alt="" src={'/images/homepage/quatrinh2-mobi.png'} width={730} height={720} />
        </div>
        ...
        <div className='md:absolute flex items-center space-x-[3.2rem] md:left-1/2 md:bottom-[16rem]  md:-translate-x-1/2 md:w-[76.40625rem] md:h-[44.387rem] shrink-0'>
          {/* WEB áo đỏ  */}
          <Image className="xmd:hidden md:w-[45.12425rem] h-[44.387rem]" priority alt="ảnh tôn chỉ áo đỏ" src={'/images/homepage/quatrinh1.png'} width={730} height={720} />

          {/* WEB + MOBI ducanh connect */}
          <div className="absolute z-[2] xmd:top-[41.7rem] xmd:left-[-2.3rem] md:top-[12.37rem] md:left-[3.9rem] flex md:w-[17.8125rem] md:h-[11.4375rem] flex-col xmd:items-start items-end xmd:space-y-[0.5rem] space-y-[1rem] shrink-0">
          ...
          {/* WEB */}
          <Image alt="mouse cursor" className="xmd:hidden absolute w-[2.56356rem] h-[2.71663rem] top-[30.37rem] left-[18.9rem]" priority
            src={'/images/homepage/mouse-cursor.png'} width={50} height={50} />
          <Image alt="ảnh" className={`xmd:hidden  absolute w-[3.96356rem] h-[3.91663rem] top-[28.57rem] left-[17.7rem] circle  opacity-100 size-[3.8rem] `} priority src={'/images/homepage/hover-title.svg'} width={92} height={92} />

          {/* WEB */}
          <Image className="xmd:hidden absolute -bottom-[1.1rem] z-[-1] left-28 w-[78.875rem] h-[9.1875rem]" priority alt="ảnh sáng tam giác" src={'/images/homepage/bg-quatrinh1.png'} width={1300} height={150} />
          ...
          <div className="xmd:absolute xmd:top-[48.3rem] xmd:right-[0.5rem] z-[2] md:mb-20 flex md:w-[24.5625rem] md:h-[26.5625rem] flex-col items-start xmd:space-y-[0.67269rem] space-y-[1.875rem] shrink-0">
            {data.map((d, i) => (
              <div
                ...
                <Image className={` ${hover && index === i ? 'circle !opacity-100' : ''} opacity-0 size-[3.8rem] absolute -left-[1.2rem] top-[1.55rem] `} priority alt="ảnh" src={'/images/homepage/hover-title.svg'} width={92} height={92} />
      ...
      <div className="relative  xmd:h-[42.6rem] h-[40rem]">

        <div className=" absolute xmd:z-[2] xmd:-top-[12.3rem] -top-[25rem] md:h-[88rem]">
          <div className=' z-[10] xmd:h-[44.4375rem]  md:sticky -top-[5rem]'>
            <Image priority alt="ảnh nền xanh nước biển , phần sticky" src={'/images/homepage/bg-quatrinh2.png'} width={1600} height={720}
              className="xmd:hidden  z-[10] h-[44.4375rem]  " />
            <Image priority alt="ảnh nền xanh nước biển , phần sticky" src={'/images/homepage/quatrinh3-mobi.png'} width={1050} height={1000}
              className="md:hidden z-[10] w-screen  " />
            <div className=" absolute  z-50 xmd:top-[7rem] xmd:left-1/2 xmd:-translate-x-1/2 top-[15rem] left-[5rem] inline-flex flex-col items-start xmd:space-y-[0.5] space-y-[1.5]">
              ...
              <div className="flex flex-col items-start xmd:space-y-[1.5rem] space-y-[1rem]">
                ...
                ">
                  ...
                  <Image priority alt="ảnh icon button" src={'/images/homepage/icon_button_quatrinh.png'} width={400} height={400} className=" xmd:hidden w-[1.01856rem] h-[1.07844rem] shrink-0" />
                </button>
              </div>
            </div>
          </div>
        ...
        <Image priority alt="ảnh nền xanh mờ web" src={'/images/homepage/bg-quatrinh3.jpeg'} width={1600} height={920}
          className="xmd:hidden w-[193.875rem] h-[70.5rem] shrink-0" />
        <Image priority alt="ảnh nền xanh mờ web" src={'/images/homepage/union-blue.png'} width={1600} height={920}
        ...
        <div className=' flex z-[12] space-x-[1.7rem] items-start absolute xmd:top-[12rem] xmd:left-1/2 xmd:-translate-x-1/2  -top-[14rem] md:right-[15rem]  '>
          <div className="flex flex-col xmd:space-y-[1.79rem] space-y-[2.19rem]">
            ...
            <Section num={'40+'} text={'TRƯỜNG HỌC LIÊN KẾT'} />
            <Section mobi={isMobile ? true : false} num={'2000+'} text={'TRƯỜNG HỌC LIÊN KẾT'} />
          </div>
