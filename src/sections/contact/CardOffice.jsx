...
const CardOffice = () => {
  return (
    <div className='w-full md:w-[21.875rem] md:h-[20.1875rem] rounded-[0.75rem] bg-white relative  border border-[rgba(52,104,205,0.40)]'>
      ...
      <div className="absolute right-[2rem] top-[2rem] th-fl bg-white size-[2.5rem] p-[0.5rem] shrink-0 rounded-[0.375rem] border border-[rgba(52,104,205,0.50)]">
      ...
      <Image alt='ss' src='/images/contact/img1.jpg'
        className='mt-[1.44rem] px-[0.93rem] pb-[1rem] rounded-[0.375rem] shrink-0 mx-auto' width={9999} height={9999} />
    </div>
  )
}
