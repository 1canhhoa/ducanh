...
export default function DichvuDA({text, dataAcf}) {
  return (
    <main className='w-full'>
      <section className='flex flex-col pt-[8rem] px-[11.56rem] xmd:px-0 mb-[5rem] xmd:mb-[2rem]'>
        ...
        <div className='flex xmd:flex-col lg:space-x-[5rem] xmd:space-y-[2rem]'>
          ...
          <Image
            className='xmd:h-[27.4375rem] xmd:w-[23.4375rem] lg:rounded-[1.25rem] w-[32.0625rem] h-[37.6875rem]'
