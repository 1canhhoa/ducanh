    ...
    <section className='w-full mt-[8.12rem] xmd:mt-[3rem]'>
      <div className='flex flex-col xmd:px-[0.75rem] items-start lg:w-[76.875rem] lg:mx-auto xlg:px-[5.3rem]'>
        <div className='h-[27.125rem] xlg:w-full w-[76.875rem] xmd:h-[16.45313rem] xmd:w-[21.9375rem] mb-[4.12rem] xmd:mb-[1.5rem]'>
          ...
          />
          <Image
            className='rounded-[0.75rem size-full lg:hidden xmd:block xlg:hidden'
            alt='Học bổng'
        ...
        <h1 className='title title relative w-fit mb-[1.5rem]'>
          {text.information.title_4}
          <div className='size-[0.625rem] xmd:hidden bg-secondary-40 absolute bottom-[0.625rem] right-[-1.125rem]'></div>
        </h1>
        <p className='w-[35.375rem] xmd:w-[21.9375rem] body16 text-greyscaletext-50'>
          {text.information.text_title_4}
        </p>

        <div className='flex xmd:w-auto xlg:w-full xmd:flex-col xlg:justify-between xmd:justify-start space-y-[0.75rem] justify-start lg:space-x-[6.87rem]'>
      ...
      <div className='flex flex-col space-y-[5rem] xmd:space-y-[1.5rem]'>
        <div className='flex flex-col items-start w-full xmd:px-[0.75rem] xmd:py-[2rem] xlg:px-[5.3rem] px-[11.625rem] py-[3.75rem] space-y-[1.5rem] bg-background-elevation-10'>
          ...
          <div className='flex xmd:flex-col items-start xmd:space-y-[0.75rem] lg:space-x-[1.5rem] w-full xlg:space-x-[1.5rem] xmd:space-x-0'>
        ...
        <div className='flex flex-col items-start space-y-[1.5rem] w-full xmd:px-[0.75rem] xlg:px-[5.3rem] px-[11.625rem]'>
          ...
          <div className='flex xmd:flex-col lg:space-x-[8.12rem] xmd:space-y-[1.5rem] items-start w-full xlg:space-x-[1.5rem] xmd:space-x-0'>
        ...
        <div className='flex flex-col items-start space-y-[1.5rem] w-full xlg:px-[5.3rem] lg:px-[11.625rem] xmd:px-[0.75rem]'>
          <h2 className='desktop32 xmd:mb20 font-bold text-primary-50 flex items-center'>
            <Image
              className='size-[0.75rem] mr-[0.5rem] lg:mt-[1rem]'
              alt='icon'
          ...
          <div className='flex xmd:flex-col xmd:space-y-[1.5rem] xmd:space-x-0 space-x-[1.5rem] items-start w-full'>
        ...
        <div className='xmd:px-[0.75rem] xlg:px-[5.3rem] px-[11.625rem] w-full flex flex-col justify-start items-start'>
          <div className='relative w-full h-[25.8125rem] xmd:h-[45.25rem] xmd:pt-[1.5rem] xmd:pl-[1rem] pt-[2.95rem] pl-[2.45rem]'>
            ...
            />
            <Image
              className='rounded-[0.75rem] absolute top-0 left-0 size-full lg:hidden xlg:hidden xmd:block'
              alt='banner hồ sơ xin học bổng'
          ...
          <div className='mt-[3.75rem] xmd:mt-[1.5rem] flex flex-col space-y-[1.3rem]'>
            ...
            <p className='body14 xmd:text-[0.875rem] xlg:text-[1rem] lg:w-[37.625rem] text-greyscaletext-80'>
