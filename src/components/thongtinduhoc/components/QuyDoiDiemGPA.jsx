    ...
    >
      <div className='flex flex-col items-start space-y-[2rem] lg:w-[76.4375rem] lg:mx-auto xmd:px-[0.75rem] xlg:px-[5.3rem] '>
        ...
        <ul className='flex flex-col items-start space-y-[1rem]'>
          <li className='text-[1rem] xlg:text-[1.5rem] xmd:text-[1rem] font-medium text-greyscaletext-60 leading-[1.5]'>
        ...
        <Image
          className='h-[40.48813rem] w-[76.4375rem] xmd:w-[21.9375rem] xmd:h-[12.9375rem] xlg:w-full rounded-[0.75rem]'
          alt='ảnh quy đổi GPA'
