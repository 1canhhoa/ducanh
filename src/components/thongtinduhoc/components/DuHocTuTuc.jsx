export default function DuHocTuTuc({text}) {
  return (
    <section className='w-full mt-[5rem] xmd:mt-[2rem]'>
      <div className='w-full lg:space-y-[2.06rem] lg:h-[29.5rem] xmd:px-[0.75rem] xlg:px-[5.3rem] px-[11.62rem] lg:bg-background-elevation-10 flex flex-col justify-center items-start'>
        ...
        <div className='flex xmd:flex-col xmd:space-y-[1rem] justify-between w-full xlg:space-x-[2rem] xmd:space-x-0'>
          <p className='lg:w-[36rem] xmd:w-[21.9375rem] xmd:body16 text-[1.5rem] font-bold text-primary-50 leading-[1.5]'>
