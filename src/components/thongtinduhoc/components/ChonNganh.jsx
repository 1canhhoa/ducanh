    ...
    <section className='w-full mt-[5rem] xmd:mt-[3rem]'>
      <div className='w-full xmd:px-[0.75rem] xlg:px-[5.3rem] px-[11.62rem] flex flex-col justify-center items-start'>
        <h1 className='title xmd:mb32 relative w-fit mb-[2.05rem] xmd:mb-[1rem] xmd:flex xmd:items-end'>
          ...
          <div className='size-[0.625rem] bg-secondary-40 lg:absolute bottom-[0.625rem] right-[-1.125rem] xmd:hidden xlg:absolute'></div>
        </h1>
        <div className='flex w-full justify-between items-center'>
          <div className='flex flex-col items-start lg:w-[38.375rem] xmd:w-[21.9375rem]'>
            ...
            <Image
              className='lg:hidden xlg:hidden xmd:block'
              alt='chọn ngành'
      ...
      <div className='w-full pt-[4.875rem] xmd:px-[0.75rem] xlg:px-[5.3rem] px-[11.5625rem] pb-[6.25rem] bg-white flex flex-col items-center'>
        <div className='flex flex-col w-full items-start'>
          ...
          <div className='flex flex-col space-y-[1rem]'>
            ...
            <div className='flex xmd:flex-col lg:space-x-[1rem] xlg:space-x-[1rem] xmd:space-x-0 xmd:space-y-[0.62rem]'>
          ...
          <div className='xmd:space-y-[0.75rem] mt-[3rem] xmd:w-full xlg:w-full w-[76.875rem] flex flex-wrap justify-start'>
            <div className='xmd:py-[2rem] mt-4 xmd:pr-[1.9375rem] xmd:h-[9.625rem] xlg:pl-[1.5rem] xmd:pl-[1.875rem] h-[18.125rem] xmd:w-full w-[37rem] xmd:mr-0 mr-[1.3rem] space-x-[1.69rem] xmd:space-x-[0.75rem] flex justify-center items-center rounded-[0.75rem] border-[1px] border-solid border-[rgba(52,104,205,0.40)] bg-white'>
            ...
            {new Array(7).fill(0).map((e, index) => (
              <div
                key={index}
                className='relative mt-4 xmd:h-[10.25rem] xmd:w-[21.9375rem] xmd:rounded-[0.625rem] xmd:mr-0 mr-[1.42rem] flex justify-center lg:items-end h-[18.125rem] w-[17.75rem] rounded-[0.75rem] border-[1px] border-solid border-greyscaletext-5 xmd:border-[rgba(19,43,125,0.20)]'
              >
                <Image
                  className='absolute xmd:relative top-0 left-0 size-full xmd:w-[9.25rem] xmd:h-[10.25rem] xmd:rounded-[0.625rem] rounded-[0.75rem]'
                  alt='các ngành'
                  src={'/images/thongtinduhoc/layer.jpg'}
                  width={284}
                  height={290}
                />
                <div className='flex flex-col items-center justify-end xmd:w-full xmd:h-[8.125rem] xmd:ml-[0.875rem]'>
                  <span className='lg:relative xlg:mb-[2rem] xmd:mb-0 xmd:body12 xmd:w-[11.0625rem] z-10 lg:h-[1.5rem] lg:mb-[1.75rem] lg:ml-[1.25rem] lg:px-[1.25rem] flex justify-start items-center text-[1rem] text-white xmd:text-primary-50 font-extrabold xmd:font-bold uppercase'>
                    Công nghệ thông tin
                  </span>
                  <span className='lg:hidden xlg:hidden xmd:block body12 text-greyscaletext-80 font-normal w-[11.0625rem]'>
      ...
      <div className='w-full lg:pt-[5rem] xmd:px-[0.75rem] px-[11.62rem] flex flex-col items-start lg:space-y-[2.25rem]'>
        ...
        <div className='w-full flex lg:space-x-[3.75rem] xlg:space-x-[2rem] xmd:space-x-0'>
