        ...
        >
          <tbody>
            <tr className='h-[3.875rem] flex rounded-t-[0.75rem] items-center bg-gradient-to-r from-[#2E6BC6] to-[#2E6BC6]'>
              <th className='lg:w-[10.75rem] h-full py-[1rem] pr-[1rem] pl-[1.95rem] flex justify-start items-center body16 font-bold text-white '>
                {text.information.h2_predicted_costs.title1_table}
              </th>
              <th className='lg:w-[11.875rem] h-full py-[1rem] p-[1rem] flex justify-center items-center leading-[1.3] body16 font-bold text-white '>
                {text.information.h2_predicted_costs.title2_table}
              </th>
              <th className='lg:w-[11.875rem] h-full py-[1rem] pr-[1rem] pl-[2rem] flex justify-center items-center leading-[1.3] body16 font-bold text-white '>
            ...
            <tr className='flex justify-center items-center'>
              <td className='w-[10.75rem] h-[3.5rem] py-[1rem] px-[2rem] flex flex-col items-center justify-center'>
                <p className='flex-1 text-primary-50 font-bold text-[0.875rem]'>
                  Anh
                </p>
              </td>
