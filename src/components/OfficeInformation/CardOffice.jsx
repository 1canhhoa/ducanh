...
const CardOffice = () => {
  return (
    <div className='w-full rounded-[0.75rem] bg-white relative  border border-[rgba(52,104,205,0.40)]'>
      ...
      <div className="absolute right-[1rem] top-[1rem] flex justify-center items-center bg-white size-[2.5rem] p-[0.5rem] shrink-0 rounded-[0.375rem] border border-[rgba(52,104,205,0.50)]">
      ...
      <Image property='' alt='ảnh địa điểm văn phòng' src='/images/contact/img1.jpg'
        className='mt-[1.44rem] w-full px-[0.93rem] pb-[1rem] rounded-[0.375rem] shrink-0' width={330} height={140} />
    </div>
  )
}
