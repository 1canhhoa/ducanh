    ...
    <>
      ...
      >
        <svg className={`${outline ? 'group-hover:stroke-white stroke-primary-40' : 'stroke-white'} duration-300 ease-linear size-[1.25rem]`} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          <path d="M12.4993 15.8307L6.66602 9.9974L12.4993 4.16406" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </button>
      ...
      >
        <svg className={`${outline ? 'group-hover:stroke-white stroke-primary-40' : 'stroke-white'} duration-300 ease-linear size-[1.25rem]`} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          <path d="M7.50065 15.8307L13.334 9.9974L7.50065 4.16406" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </button>
    </>
  )
