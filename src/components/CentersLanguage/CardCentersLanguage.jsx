...
const CardCentersLanguage = () => {
  return (
    <div className=' flex flex-1 w-full flex-col relative items-start justify-start space-y-[0.75rem]  p-[1.5rem] rounded-[0.75rem] bg-white  border border-[rgba(52,104,205,0.40)]'>
